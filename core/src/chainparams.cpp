...
Lilith Network Is new Light speed system by v6 network mubdi 
...
static MapCheckpoints mapCheckpoints = {
    ...
    //{ 1,   uint256S("000000419f9175ac5edb860d7ac724b3a84c8ae260e90fdbfd0ea3c276d2fd5d")},   //checkpoint updates for change key from cxau to rci
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1752809959, 8067108, 0x1e0ffff0, 1, 300 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf115ea61f4b1c6dd5071634ee64f0590bf31a902e8b01e2d0f7a26d5311ee756"));
        assert(genesis.hashMerkleRoot == uint256S("0x4fa19c925ec84058a18aafd21c6c8da26c08888a1ebea6b050f3be0ae2478700"));
        ...
        // spork keys
        consensus.strSporkPubKey = "04d50bcce7270b67548b648f5831eacce8b2af598dafc3194756eddd8ebe1a4cdc56efce3c6850f542989a5ace49ebaf5b9646cb0cb64dbbb80077dfa5ca7fb485";
        consensus.strSporkPubKeyOld = "04e0e3443668a549effa9549d9a31428009364c17ec7ee743573e2846d2c520864a2055cfa79ec79ead55252a76d9e690ec7282443b49008e1694482b227572270";
        consensus.nTime_EnforceNewSporkKey = 1735540194;    //!> Sporks signed after  must use the new spork key
        consensus.nTime_RejectOldSporkKey = 1752844806;     //!> Fully reject old spork key after Tue, 31 May 2022 00:00:00 GMT
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x01, 0x02, 0x70, 0xca};
        base58Prefixes[EXT_SECRET_KEY] = {0x01, 0x02, 0x18, 0x5f};
        // BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        base58Prefixes[EXT_COIN_TYPE] = {0x01, 0x02, 0xb1, 0x82};
