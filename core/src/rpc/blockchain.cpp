...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    if (block.IsProofOfStake()) {
        ...
        std::string stakeModifier = (Params().GetConsensus().NetworkUpgradeActive(blockindex->nHeight, Consensus::UPGRADE_V3) ?
...
UniValue getsupplyinfo(const JSONRPCRequest& request)
{
    ...
    const CAmount aSupply = Params().GetConsensus().AnchorSupply * COIN;
    ret.pushKV("updateheight", MoneySupply.GetCacheHeight());
    const CAmount mSupply = tSupply - aSupply;
    ret.pushKV("transparentsupply", ValueFromAmount(mSupply));
    ret.pushKV("anchor_supply", ValueFromAmount(aSupply));
...
UniValue gettxout(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "  \"value\" : x.xxx,           (numeric) The transaction value in EAPP\n"
            "  \"scriptPubKey\" : {         (json object)\n"
            "     \"asm\" : \"code\",       (string) \n"
            "     \"hex\" : \"hex\",        (string) \n"
            "     \"reqSigs\" : n,          (numeric) Number of required signatures\n"
            "     \"type\" : \"pubkeyhash\", (string) The type, eg pubkeyhash\n"
            "     \"addresses\" : [          (array of string) array of engineapp addresses\n"
            "     \"mubdiaddress\"           (string) engineapp address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
...
static UniValue SoftForkMajorityDesc(int version, const CBlockIndex* pindex, const Consensus::Params& consensusParams)
{
    ...
    case 3:
        ...
        break;
    case 4:
        idx = Consensus::UPGRADE_HYBRID;
        break;
    case 5:
        idx = Consensus::UPGRADE_BIP65;
        break;
    case 6:
        idx = Consensus::UPGRADE_V2;
        break;
    case 7:
        idx = Consensus::UPGRADE_V3;
        break;
    case 8:
        idx = Consensus::UPGRADE_V4;
        break;
    case 9:
        idx = Consensus::UPGRADE_V5;
        break;
    case 10:
        idx = Consensus::UPGRADE_V6;
        break;
    default:
